pipeline {
    ...
    environment {
        GIT_REPOSITORY_URL = 'https://github.com/sachink786/docker_jenkins_demo.git'
        DOCKER_IMAGE_NAME = 'sachink786/docker_jenkins_demo'
        IMAGE_TAG = '1.0'
    }
                ...
                script {
                    try {
                        withCredentials([usernamePassword(credentialsId: 'my-dockerhub-credentials-id', 
                                                         usernameVariable: 'sachink786', 
                                                         passwordVariable: 'sachink785')]) {
